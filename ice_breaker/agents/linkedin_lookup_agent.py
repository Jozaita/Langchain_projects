...
def lookup(name:str)->str:
    ...
    template = """
    given the full name {name} I want you to get a link for their LinkedIn profile page. Your answer should contain just the URL """
    ...
    tools_for_agent = [
        Tool(
            ...
            description="useful when you need to crawl a LinkedIn profile"
        )
    ]
